...
let () =
  ...
  assert (Pb_option.Constant_int (-1) = test_default "[default = -1]");
  assert (
    Pb_option.Constant_string "hello" = test_default "[default = \"hello\"]");
  assert (
    Pb_option.Constant_string "he'l'lo" = test_default "[default = \"he'l'lo\"]");
  assert (
    Pb_option.Constant_string "he\"l\"lo"
    = test_default "[default = \"he\\\"l\\\"lo\"]");
  assert (Pb_option.Constant_float 1.23 = test_default "[default = 1.23]");
  assert (Pb_option.Constant_float (-1.23) = test_default "[default = -1.23]");
  assert (Pb_option.Constant_bool true = test_default "[default = true]");
  assert (Pb_option.Constant_bool false = test_default "[default = false]");
  ()
