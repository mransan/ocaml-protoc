...
let () =
  let proto = parse "syntax = \"proto2\"; message M { string no_label = 1; }" in
...
let () =
  let proto =
    parse
      "syntax = \"proto3\"; message M { string no_label = 1; repeated string r \
       = 2; message S {string s_no_label = 3; repeated string s_r = 4; } }"
  in
...
let () =
  let proto =
    parse "syntax = \"proto3\"; message M { required string no_label = 1; }"
  in
...
let () =
  let proto =
    parse
      "syntax = \"proto3\"; message M { message S { required string no_label = \
       1; }}"
  in
...
let () =
  let proto =
    parse "syntax = \"proto3\"; enum E { EN1 = 1; EN2 = 2; } message M { } "
  in
...
let () =
  let proto =
    parse "syntax = \"proto3\"; message M { enum E { EN1 = 1; EN2 = 2; } }"
  in
...
let () =
  let proto =
    parse "syntax = \"proto3\"; message M { enum E { EN0 = 0; EN2 = 2; } }"
  in
