let () =
  ...
  let single_one_of_string = String_value "This is the single one \"string\"" in

  let single_one_of_int = Int_value 0xEFABABABl in

  let single_one_of_enum = Enum_value test_enum0 in

  let single_one_of_small_message = Small_message small_message in

  let single_one_of_recursive = Recursive_value single_one_of_small_message in
  ...
  let test =
    {
      ...
      repeated_small_message =
        [ { sm_string = "sm1" }; { sm_string = "sm2" }; { sm_string = "sm3" } ];
