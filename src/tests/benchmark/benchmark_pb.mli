...
val default_test_response_data : unit -> test_response_data
(** [default_test_response_data ()] is the default value for type [test_response_data] *)

val default_test_response : 
  ?difficulty_size:int ->
  ?test_id:test_id ->
  ?data:test_response_data ->
  unit ->
...
val decode_test_response_data : Pbrt.Decoder.t -> test_response_data
(** [decode_test_response_data decoder] decodes a [test_response_data] value from [decoder] *)
...
val encode_test_response_data : test_response_data -> Pbrt.Encoder.t -> unit
(** [encode_test_response_data v encoder] encodes [v] with the given [encoder] *)
