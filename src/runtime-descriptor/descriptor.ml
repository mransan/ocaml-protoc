...
type oneof_options = { mutable uninterpreted_option: uninterpreted_option list }
...
type source_code_info = { mutable location: source_code_info_location list }
...
type file_descriptor_set = { mutable file: file_descriptor_proto list }
...
let default_field_descriptor_proto_label () =
  (Label_optional : field_descriptor_proto_label)

let default_field_descriptor_proto_type () =
  (Type_double : field_descriptor_proto_type)
...
let default_enum_value_descriptor_proto () : enum_value_descriptor_proto =
  { _presence = Pbrt.Bitfield.empty; name = ""; number = 0l; options = None }
...
let default_enum_descriptor_proto_enum_reserved_range () :
    enum_descriptor_proto_enum_reserved_range =
  { _presence = Pbrt.Bitfield.empty; start = 0l; end_ = 0l }
...
let default_descriptor_proto_extension_range () :
    descriptor_proto_extension_range =
  { _presence = Pbrt.Bitfield.empty; start = 0l; end_ = 0l; options = None }

let default_oneof_options () : oneof_options = { uninterpreted_option = [] }

let default_oneof_descriptor_proto () : oneof_descriptor_proto =
  { _presence = Pbrt.Bitfield.empty; name = ""; options = None }
...
let default_method_options_idempotency_level () =
  (Idempotency_unknown : method_options_idempotency_level)
...
let default_service_descriptor_proto () : service_descriptor_proto =
  { _presence = Pbrt.Bitfield.empty; name = ""; method_ = []; options = None }
...
let default_source_code_info () : source_code_info = { location = [] }
...
let default_file_descriptor_set () : file_descriptor_set = { file = [] }
...
let default_generated_code_info () : generated_code_info = { annotation = [] }

(** {2 Make functions} *)

let[@inline] uninterpreted_option_name_part_set_name_part
    (self : uninterpreted_option_name_part) (x : string) : unit =
  self.name_part <- x

let[@inline] uninterpreted_option_name_part_set_is_extension
    (self : uninterpreted_option_name_part) (x : bool) : unit =
  self.is_extension <- x

let copy_uninterpreted_option_name_part (self : uninterpreted_option_name_part)
    : uninterpreted_option_name_part =
  { self with name_part = self.name_part }

let make_uninterpreted_option_name_part ~(name_part : string)
    ~(is_extension : bool) () : uninterpreted_option_name_part =
...
let[@inline] uninterpreted_option_has_identifier_value
    (self : uninterpreted_option) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] uninterpreted_option_has_positive_int_value
    (self : uninterpreted_option) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] uninterpreted_option_has_negative_int_value
    (self : uninterpreted_option) : bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] uninterpreted_option_has_double_value (self : uninterpreted_option)
    : bool =
  Pbrt.Bitfield.get self._presence 3

let[@inline] uninterpreted_option_has_string_value (self : uninterpreted_option)
    : bool =
  Pbrt.Bitfield.get self._presence 4

let[@inline] uninterpreted_option_has_aggregate_value
    (self : uninterpreted_option) : bool =
  Pbrt.Bitfield.get self._presence 5

let[@inline] uninterpreted_option_set_name (self : uninterpreted_option)
    (x : uninterpreted_option_name_part list) : unit =
  self.name <- x

let[@inline] uninterpreted_option_set_identifier_value
    (self : uninterpreted_option) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.identifier_value <- x

let[@inline] uninterpreted_option_set_positive_int_value
    (self : uninterpreted_option) (x : int64) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.positive_int_value <- x

let[@inline] uninterpreted_option_set_negative_int_value
    (self : uninterpreted_option) (x : int64) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.negative_int_value <- x

let[@inline] uninterpreted_option_set_double_value (self : uninterpreted_option)
    (x : float) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 3;
  self.double_value <- x

let[@inline] uninterpreted_option_set_string_value (self : uninterpreted_option)
    (x : bytes) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 4;
  self.string_value <- x

let[@inline] uninterpreted_option_set_aggregate_value
    (self : uninterpreted_option) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 5;
  self.aggregate_value <- x

let copy_uninterpreted_option (self : uninterpreted_option) :
    uninterpreted_option =
  { self with name = self.name }

let make_uninterpreted_option ?(name = []) ?(identifier_value : string option)
    ?(positive_int_value : int64 option) ?(negative_int_value : int64 option)
    ?(double_value : float option) ?(string_value : bytes option)
    ?(aggregate_value : string option) () : uninterpreted_option =
...
let[@inline] field_options_has_ctype (self : field_options) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] field_options_has_packed (self : field_options) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] field_options_has_jstype (self : field_options) : bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] field_options_has_lazy_ (self : field_options) : bool =
  Pbrt.Bitfield.get self._presence 3

let[@inline] field_options_has_unverified_lazy (self : field_options) : bool =
  Pbrt.Bitfield.get self._presence 4

let[@inline] field_options_has_deprecated (self : field_options) : bool =
  Pbrt.Bitfield.get self._presence 5

let[@inline] field_options_has_weak (self : field_options) : bool =
  Pbrt.Bitfield.get self._presence 6

let[@inline] field_options_set_ctype (self : field_options)
    (x : field_options_ctype) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.ctype <- x
...
let[@inline] field_options_set_jstype (self : field_options)
    (x : field_options_jstype) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.jstype <- x
...
let[@inline] field_options_set_unverified_lazy (self : field_options) (x : bool)
    : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 4;
  self.unverified_lazy <- x

let[@inline] field_options_set_deprecated (self : field_options) (x : bool) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 5;
  self.deprecated <- x

let[@inline] field_options_set_weak (self : field_options) (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 6;
  self.weak <- x

let[@inline] field_options_set_uninterpreted_option (self : field_options)
    (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x

let copy_field_options (self : field_options) : field_options =
  { self with ctype = self.ctype }

let make_field_options ?(ctype : field_options_ctype option)
    ?(packed : bool option) ?(jstype : field_options_jstype option)
    ?(lazy_ : bool option) ?(unverified_lazy : bool option)
    ?(deprecated : bool option) ?(weak : bool option)
...
let[@inline] field_descriptor_proto_has_name (self : field_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] field_descriptor_proto_has_number (self : field_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] field_descriptor_proto_has_label (self : field_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] field_descriptor_proto_has_type_ (self : field_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 3

let[@inline] field_descriptor_proto_has_type_name
    (self : field_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 4

let[@inline] field_descriptor_proto_has_extendee (self : field_descriptor_proto)
    : bool =
  Pbrt.Bitfield.get self._presence 5

let[@inline] field_descriptor_proto_has_default_value
    (self : field_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 6

let[@inline] field_descriptor_proto_has_oneof_index
    (self : field_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 7

let[@inline] field_descriptor_proto_has_json_name
    (self : field_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 8

let[@inline] field_descriptor_proto_has_options (self : field_descriptor_proto)
    : bool =
  self.options != None

let[@inline] field_descriptor_proto_has_proto3_optional
    (self : field_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 9

let[@inline] field_descriptor_proto_set_name (self : field_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] field_descriptor_proto_set_number (self : field_descriptor_proto)
    (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.number <- x

let[@inline] field_descriptor_proto_set_label (self : field_descriptor_proto)
    (x : field_descriptor_proto_label) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.label <- x

let[@inline] field_descriptor_proto_set_type_ (self : field_descriptor_proto)
    (x : field_descriptor_proto_type) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 3;
  self.type_ <- x

let[@inline] field_descriptor_proto_set_type_name
    (self : field_descriptor_proto) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 4;
  self.type_name <- x

let[@inline] field_descriptor_proto_set_extendee (self : field_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 5;
  self.extendee <- x

let[@inline] field_descriptor_proto_set_default_value
    (self : field_descriptor_proto) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 6;
  self.default_value <- x

let[@inline] field_descriptor_proto_set_oneof_index
    (self : field_descriptor_proto) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 7;
  self.oneof_index <- x

let[@inline] field_descriptor_proto_set_json_name
    (self : field_descriptor_proto) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 8;
  self.json_name <- x

let[@inline] field_descriptor_proto_set_options (self : field_descriptor_proto)
    (x : field_options) : unit =
  self.options <- Some x

let[@inline] field_descriptor_proto_set_proto3_optional
    (self : field_descriptor_proto) (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 9;
  self.proto3_optional <- x

let copy_field_descriptor_proto (self : field_descriptor_proto) :
    field_descriptor_proto =
  { self with name = self.name }

let make_field_descriptor_proto ?(name : string option) ?(number : int32 option)
    ?(label : field_descriptor_proto_label option)
    ?(type_ : field_descriptor_proto_type option) ?(type_name : string option)
    ?(extendee : string option) ?(default_value : string option)
    ?(oneof_index : int32 option) ?(json_name : string option)
    ?(options : field_options option) ?(proto3_optional : bool option) () :
    field_descriptor_proto =
...
let[@inline] enum_value_options_has_deprecated (self : enum_value_options) :
    bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] enum_value_options_set_deprecated (self : enum_value_options)
    (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.deprecated <- x

let[@inline] enum_value_options_set_uninterpreted_option
    (self : enum_value_options) (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x

let copy_enum_value_options (self : enum_value_options) : enum_value_options =
  { self with deprecated = self.deprecated }

let make_enum_value_options ?(deprecated : bool option)
...
let[@inline] enum_value_descriptor_proto_has_name
    (self : enum_value_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] enum_value_descriptor_proto_has_number
    (self : enum_value_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] enum_value_descriptor_proto_has_options
    (self : enum_value_descriptor_proto) : bool =
  self.options != None

let[@inline] enum_value_descriptor_proto_set_name
    (self : enum_value_descriptor_proto) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] enum_value_descriptor_proto_set_number
    (self : enum_value_descriptor_proto) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.number <- x

let[@inline] enum_value_descriptor_proto_set_options
    (self : enum_value_descriptor_proto) (x : enum_value_options) : unit =
  self.options <- Some x

let copy_enum_value_descriptor_proto (self : enum_value_descriptor_proto) :
    enum_value_descriptor_proto =
  { self with name = self.name }

let make_enum_value_descriptor_proto ?(name : string option)
    ?(number : int32 option) ?(options : enum_value_options option) () :
    enum_value_descriptor_proto =
...
let[@inline] enum_options_has_allow_alias (self : enum_options) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] enum_options_has_deprecated (self : enum_options) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] enum_options_set_allow_alias (self : enum_options) (x : bool) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.allow_alias <- x
...
let[@inline] enum_options_set_uninterpreted_option (self : enum_options)
    (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x
...
let make_enum_options ?(allow_alias : bool option) ?(deprecated : bool option)
...
let[@inline] enum_descriptor_proto_enum_reserved_range_has_start
    (self : enum_descriptor_proto_enum_reserved_range) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] enum_descriptor_proto_enum_reserved_range_has_end_
    (self : enum_descriptor_proto_enum_reserved_range) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] enum_descriptor_proto_enum_reserved_range_set_start
    (self : enum_descriptor_proto_enum_reserved_range) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.start <- x

let[@inline] enum_descriptor_proto_enum_reserved_range_set_end_
    (self : enum_descriptor_proto_enum_reserved_range) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.end_ <- x

let copy_enum_descriptor_proto_enum_reserved_range
    (self : enum_descriptor_proto_enum_reserved_range) :
    enum_descriptor_proto_enum_reserved_range =
  { self with start = self.start }

let make_enum_descriptor_proto_enum_reserved_range ?(start : int32 option)
    ?(end_ : int32 option) () : enum_descriptor_proto_enum_reserved_range =
...
let[@inline] enum_descriptor_proto_has_name (self : enum_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] enum_descriptor_proto_has_options (self : enum_descriptor_proto) :
    bool =
  self.options != None

let[@inline] enum_descriptor_proto_set_name (self : enum_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] enum_descriptor_proto_set_value (self : enum_descriptor_proto)
    (x : enum_value_descriptor_proto list) : unit =
  self.value <- x

let[@inline] enum_descriptor_proto_set_options (self : enum_descriptor_proto)
    (x : enum_options) : unit =
  self.options <- Some x

let[@inline] enum_descriptor_proto_set_reserved_range
    (self : enum_descriptor_proto)
    (x : enum_descriptor_proto_enum_reserved_range list) : unit =
  self.reserved_range <- x

let[@inline] enum_descriptor_proto_set_reserved_name
    (self : enum_descriptor_proto) (x : string list) : unit =
  self.reserved_name <- x

let copy_enum_descriptor_proto (self : enum_descriptor_proto) :
    enum_descriptor_proto =
  { self with name = self.name }

let make_enum_descriptor_proto ?(name : string option) ?(value = [])
    ?(options : enum_options option) ?(reserved_range = [])
    ?(reserved_name = []) () : enum_descriptor_proto =
...
let[@inline] extension_range_options_set_uninterpreted_option
    (self : extension_range_options) (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x

let copy_extension_range_options (self : extension_range_options) :
    extension_range_options =
  { self with uninterpreted_option = self.uninterpreted_option }

let make_extension_range_options ?(uninterpreted_option = []) () :
    extension_range_options =
  let _res = default_extension_range_options () in
  extension_range_options_set_uninterpreted_option _res uninterpreted_option;
  _res

let[@inline] descriptor_proto_extension_range_has_start
    (self : descriptor_proto_extension_range) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] descriptor_proto_extension_range_has_end_
    (self : descriptor_proto_extension_range) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] descriptor_proto_extension_range_has_options
    (self : descriptor_proto_extension_range) : bool =
  self.options != None

let[@inline] descriptor_proto_extension_range_set_start
    (self : descriptor_proto_extension_range) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.start <- x

let[@inline] descriptor_proto_extension_range_set_end_
    (self : descriptor_proto_extension_range) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.end_ <- x

let[@inline] descriptor_proto_extension_range_set_options
    (self : descriptor_proto_extension_range) (x : extension_range_options) :
    unit =
  self.options <- Some x

let copy_descriptor_proto_extension_range
    (self : descriptor_proto_extension_range) : descriptor_proto_extension_range
    =
  { self with start = self.start }

let make_descriptor_proto_extension_range ?(start : int32 option)
    ?(end_ : int32 option) ?(options : extension_range_options option) () :
    descriptor_proto_extension_range =
...
let[@inline] oneof_options_set_uninterpreted_option (self : oneof_options)
    (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x
...
let make_oneof_options ?(uninterpreted_option = []) () : oneof_options =
  let _res = default_oneof_options () in
  oneof_options_set_uninterpreted_option _res uninterpreted_option;
  _res

let[@inline] oneof_descriptor_proto_has_name (self : oneof_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] oneof_descriptor_proto_has_options (self : oneof_descriptor_proto)
    : bool =
  self.options != None

let[@inline] oneof_descriptor_proto_set_name (self : oneof_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] oneof_descriptor_proto_set_options (self : oneof_descriptor_proto)
    (x : oneof_options) : unit =
  self.options <- Some x

let copy_oneof_descriptor_proto (self : oneof_descriptor_proto) :
    oneof_descriptor_proto =
  { self with name = self.name }

let make_oneof_descriptor_proto ?(name : string option)
    ?(options : oneof_options option) () : oneof_descriptor_proto =
...
let[@inline] message_options_has_message_set_wire_format
    (self : message_options) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] message_options_has_no_standard_descriptor_accessor
    (self : message_options) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] message_options_has_deprecated (self : message_options) : bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] message_options_has_map_entry (self : message_options) : bool =
  Pbrt.Bitfield.get self._presence 3

let[@inline] message_options_set_message_set_wire_format
    (self : message_options) (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.message_set_wire_format <- x

let[@inline] message_options_set_no_standard_descriptor_accessor
    (self : message_options) (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.no_standard_descriptor_accessor <- x

let[@inline] message_options_set_deprecated (self : message_options) (x : bool)
    : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.deprecated <- x

let[@inline] message_options_set_map_entry (self : message_options) (x : bool) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 3;
  self.map_entry <- x

let[@inline] message_options_set_uninterpreted_option (self : message_options)
    (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x
...
let make_message_options ?(message_set_wire_format : bool option)
    ?(no_standard_descriptor_accessor : bool option) ?(deprecated : bool option)
    ?(map_entry : bool option) ?(uninterpreted_option = []) () : message_options
    =
...
let[@inline] descriptor_proto_reserved_range_has_start
    (self : descriptor_proto_reserved_range) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] descriptor_proto_reserved_range_has_end_
    (self : descriptor_proto_reserved_range) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] descriptor_proto_reserved_range_set_start
    (self : descriptor_proto_reserved_range) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.start <- x

let[@inline] descriptor_proto_reserved_range_set_end_
    (self : descriptor_proto_reserved_range) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.end_ <- x

let copy_descriptor_proto_reserved_range
    (self : descriptor_proto_reserved_range) : descriptor_proto_reserved_range =
  { self with start = self.start }

let make_descriptor_proto_reserved_range ?(start : int32 option)
    ?(end_ : int32 option) () : descriptor_proto_reserved_range =
...
let[@inline] descriptor_proto_has_name (self : descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] descriptor_proto_has_options (self : descriptor_proto) : bool =
  self.options != None

let[@inline] descriptor_proto_set_name (self : descriptor_proto) (x : string) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] descriptor_proto_set_field (self : descriptor_proto)
    (x : field_descriptor_proto list) : unit =
  self.field <- x

let[@inline] descriptor_proto_set_extension (self : descriptor_proto)
    (x : field_descriptor_proto list) : unit =
  self.extension <- x

let[@inline] descriptor_proto_set_nested_type (self : descriptor_proto)
    (x : descriptor_proto list) : unit =
  self.nested_type <- x

let[@inline] descriptor_proto_set_enum_type (self : descriptor_proto)
    (x : enum_descriptor_proto list) : unit =
  self.enum_type <- x

let[@inline] descriptor_proto_set_extension_range (self : descriptor_proto)
    (x : descriptor_proto_extension_range list) : unit =
  self.extension_range <- x

let[@inline] descriptor_proto_set_oneof_decl (self : descriptor_proto)
    (x : oneof_descriptor_proto list) : unit =
  self.oneof_decl <- x

let[@inline] descriptor_proto_set_options (self : descriptor_proto)
    (x : message_options) : unit =
  self.options <- Some x

let[@inline] descriptor_proto_set_reserved_range (self : descriptor_proto)
    (x : descriptor_proto_reserved_range list) : unit =
  self.reserved_range <- x

let[@inline] descriptor_proto_set_reserved_name (self : descriptor_proto)
    (x : string list) : unit =
  self.reserved_name <- x
...
let make_descriptor_proto ?(name : string option) ?(field = [])
    ?(extension = []) ?(nested_type = []) ?(enum_type = [])
    ?(extension_range = []) ?(oneof_decl = [])
    ?(options : message_options option) ?(reserved_range = [])
...
let[@inline] method_options_has_deprecated (self : method_options) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] method_options_has_idempotency_level (self : method_options) : bool
    =
  Pbrt.Bitfield.get self._presence 1

let[@inline] method_options_set_deprecated (self : method_options) (x : bool) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.deprecated <- x

let[@inline] method_options_set_idempotency_level (self : method_options)
    (x : method_options_idempotency_level) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.idempotency_level <- x

let[@inline] method_options_set_uninterpreted_option (self : method_options)
    (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x
...
let make_method_options ?(deprecated : bool option)
...
let[@inline] method_descriptor_proto_has_name (self : method_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] method_descriptor_proto_has_input_type
    (self : method_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] method_descriptor_proto_has_output_type
    (self : method_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] method_descriptor_proto_has_options
    (self : method_descriptor_proto) : bool =
  self.options != None

let[@inline] method_descriptor_proto_has_client_streaming
    (self : method_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 3

let[@inline] method_descriptor_proto_has_server_streaming
    (self : method_descriptor_proto) : bool =
  Pbrt.Bitfield.get self._presence 4

let[@inline] method_descriptor_proto_set_name (self : method_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] method_descriptor_proto_set_input_type
    (self : method_descriptor_proto) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.input_type <- x

let[@inline] method_descriptor_proto_set_output_type
    (self : method_descriptor_proto) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.output_type <- x

let[@inline] method_descriptor_proto_set_options
    (self : method_descriptor_proto) (x : method_options) : unit =
  self.options <- Some x

let[@inline] method_descriptor_proto_set_client_streaming
    (self : method_descriptor_proto) (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 3;
  self.client_streaming <- x

let[@inline] method_descriptor_proto_set_server_streaming
    (self : method_descriptor_proto) (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 4;
  self.server_streaming <- x

let copy_method_descriptor_proto (self : method_descriptor_proto) :
    method_descriptor_proto =
  { self with name = self.name }

let make_method_descriptor_proto ?(name : string option)
    ?(input_type : string option) ?(output_type : string option)
    ?(options : method_options option) ?(client_streaming : bool option)
    ?(server_streaming : bool option) () : method_descriptor_proto =
...
let[@inline] service_options_has_deprecated (self : service_options) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] service_options_set_deprecated (self : service_options) (x : bool)
    : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.deprecated <- x

let[@inline] service_options_set_uninterpreted_option (self : service_options)
    (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x
...
let make_service_options ?(deprecated : bool option)
...
let[@inline] service_descriptor_proto_has_name (self : service_descriptor_proto)
    : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] service_descriptor_proto_has_options
    (self : service_descriptor_proto) : bool =
  self.options != None

let[@inline] service_descriptor_proto_set_name (self : service_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] service_descriptor_proto_set_method_
    (self : service_descriptor_proto) (x : method_descriptor_proto list) : unit
    =
  self.method_ <- x

let[@inline] service_descriptor_proto_set_options
    (self : service_descriptor_proto) (x : service_options) : unit =
  self.options <- Some x

let copy_service_descriptor_proto (self : service_descriptor_proto) :
    service_descriptor_proto =
  { self with name = self.name }

let make_service_descriptor_proto ?(name : string option) ?(method_ = [])
    ?(options : service_options option) () : service_descriptor_proto =
...
let[@inline] file_options_has_java_package (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] file_options_has_java_outer_classname (self : file_options) : bool
    =
  Pbrt.Bitfield.get self._presence 1

let[@inline] file_options_has_java_multiple_files (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] file_options_has_java_generate_equals_and_hash
    (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 3

let[@inline] file_options_has_java_string_check_utf8 (self : file_options) :
    bool =
  Pbrt.Bitfield.get self._presence 4

let[@inline] file_options_has_optimize_for (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 5

let[@inline] file_options_has_go_package (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 6

let[@inline] file_options_has_cc_generic_services (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 7

let[@inline] file_options_has_java_generic_services (self : file_options) : bool
    =
  Pbrt.Bitfield.get self._presence 8

let[@inline] file_options_has_py_generic_services (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 9

let[@inline] file_options_has_php_generic_services (self : file_options) : bool
    =
  Pbrt.Bitfield.get self._presence 10

let[@inline] file_options_has_deprecated (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 11

let[@inline] file_options_has_cc_enable_arenas (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 12

let[@inline] file_options_has_objc_class_prefix (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 13

let[@inline] file_options_has_csharp_namespace (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 14

let[@inline] file_options_has_swift_prefix (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 15

let[@inline] file_options_has_php_class_prefix (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 16

let[@inline] file_options_has_php_namespace (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 17

let[@inline] file_options_has_php_metadata_namespace (self : file_options) :
    bool =
  Pbrt.Bitfield.get self._presence 18

let[@inline] file_options_has_ruby_package (self : file_options) : bool =
  Pbrt.Bitfield.get self._presence 19

let[@inline] file_options_set_java_package (self : file_options) (x : string) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.java_package <- x

let[@inline] file_options_set_java_outer_classname (self : file_options)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.java_outer_classname <- x

let[@inline] file_options_set_java_multiple_files (self : file_options)
    (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.java_multiple_files <- x

let[@inline] file_options_set_java_generate_equals_and_hash
    (self : file_options) (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 3;
  self.java_generate_equals_and_hash <- x

let[@inline] file_options_set_java_string_check_utf8 (self : file_options)
    (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 4;
  self.java_string_check_utf8 <- x

let[@inline] file_options_set_optimize_for (self : file_options)
    (x : file_options_optimize_mode) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 5;
  self.optimize_for <- x

let[@inline] file_options_set_go_package (self : file_options) (x : string) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 6;
  self.go_package <- x

let[@inline] file_options_set_cc_generic_services (self : file_options)
    (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 7;
  self.cc_generic_services <- x

let[@inline] file_options_set_java_generic_services (self : file_options)
    (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 8;
  self.java_generic_services <- x

let[@inline] file_options_set_py_generic_services (self : file_options)
    (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 9;
  self.py_generic_services <- x

let[@inline] file_options_set_php_generic_services (self : file_options)
    (x : bool) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 10;
  self.php_generic_services <- x

let[@inline] file_options_set_deprecated (self : file_options) (x : bool) : unit
    =
  self._presence <- Pbrt.Bitfield.set self._presence 11;
  self.deprecated <- x

let[@inline] file_options_set_cc_enable_arenas (self : file_options) (x : bool)
    : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 12;
  self.cc_enable_arenas <- x

let[@inline] file_options_set_objc_class_prefix (self : file_options)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 13;
  self.objc_class_prefix <- x

let[@inline] file_options_set_csharp_namespace (self : file_options)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 14;
  self.csharp_namespace <- x

let[@inline] file_options_set_swift_prefix (self : file_options) (x : string) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 15;
  self.swift_prefix <- x

let[@inline] file_options_set_php_class_prefix (self : file_options)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 16;
  self.php_class_prefix <- x

let[@inline] file_options_set_php_namespace (self : file_options) (x : string) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 17;
  self.php_namespace <- x

let[@inline] file_options_set_php_metadata_namespace (self : file_options)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 18;
  self.php_metadata_namespace <- x

let[@inline] file_options_set_ruby_package (self : file_options) (x : string) :
    unit =
  self._presence <- Pbrt.Bitfield.set self._presence 19;
  self.ruby_package <- x

let[@inline] file_options_set_uninterpreted_option (self : file_options)
    (x : uninterpreted_option list) : unit =
  self.uninterpreted_option <- x
...
let make_file_options ?(java_package : string option)
    ?(java_outer_classname : string option) ?(java_multiple_files : bool option)
    ...
    ?(go_package : string option) ?(cc_generic_services : bool option)
    ?(java_generic_services : bool option) ?(py_generic_services : bool option)
    ?(php_generic_services : bool option) ?(deprecated : bool option)
    ?(cc_enable_arenas : bool option) ?(objc_class_prefix : string option)
    ?(csharp_namespace : string option) ?(swift_prefix : string option)
    ?(php_class_prefix : string option) ?(php_namespace : string option)
    ?(php_metadata_namespace : string option) ?(ruby_package : string option)
...
let[@inline] source_code_info_location_has_leading_comments
    (self : source_code_info_location) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] source_code_info_location_has_trailing_comments
    (self : source_code_info_location) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] source_code_info_location_set_path
    (self : source_code_info_location) (x : int32 list) : unit =
  self.path <- x

let[@inline] source_code_info_location_set_span
    (self : source_code_info_location) (x : int32 list) : unit =
  self.span <- x

let[@inline] source_code_info_location_set_leading_comments
    (self : source_code_info_location) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.leading_comments <- x

let[@inline] source_code_info_location_set_trailing_comments
    (self : source_code_info_location) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.trailing_comments <- x

let[@inline] source_code_info_location_set_leading_detached_comments
    (self : source_code_info_location) (x : string list) : unit =
  self.leading_detached_comments <- x

let copy_source_code_info_location (self : source_code_info_location) :
    source_code_info_location =
  { self with path = self.path }

let make_source_code_info_location ?(path = []) ?(span = [])
    ?(leading_comments : string option) ?(trailing_comments : string option)
    ?(leading_detached_comments = []) () : source_code_info_location =
  ...
  source_code_info_location_set_leading_detached_comments _res
    leading_detached_comments;
  _res

let[@inline] source_code_info_set_location (self : source_code_info)
    (x : source_code_info_location list) : unit =
  self.location <- x

let copy_source_code_info (self : source_code_info) : source_code_info =
  { self with location = self.location }

let make_source_code_info ?(location = []) () : source_code_info =
  let _res = default_source_code_info () in
  source_code_info_set_location _res location;
  _res

let[@inline] file_descriptor_proto_has_name (self : file_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] file_descriptor_proto_has_package (self : file_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] file_descriptor_proto_has_options (self : file_descriptor_proto) :
    bool =
  self.options != None

let[@inline] file_descriptor_proto_has_source_code_info
    (self : file_descriptor_proto) : bool =
  self.source_code_info != None

let[@inline] file_descriptor_proto_has_syntax (self : file_descriptor_proto) :
    bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] file_descriptor_proto_set_name (self : file_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.name <- x

let[@inline] file_descriptor_proto_set_package (self : file_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.package <- x

let[@inline] file_descriptor_proto_set_dependency (self : file_descriptor_proto)
    (x : string list) : unit =
  self.dependency <- x

let[@inline] file_descriptor_proto_set_public_dependency
    (self : file_descriptor_proto) (x : int32 list) : unit =
  self.public_dependency <- x

let[@inline] file_descriptor_proto_set_weak_dependency
    (self : file_descriptor_proto) (x : int32 list) : unit =
  self.weak_dependency <- x

let[@inline] file_descriptor_proto_set_message_type
    (self : file_descriptor_proto) (x : descriptor_proto list) : unit =
  self.message_type <- x

let[@inline] file_descriptor_proto_set_enum_type (self : file_descriptor_proto)
    (x : enum_descriptor_proto list) : unit =
  self.enum_type <- x

let[@inline] file_descriptor_proto_set_service (self : file_descriptor_proto)
    (x : service_descriptor_proto list) : unit =
  self.service <- x

let[@inline] file_descriptor_proto_set_extension (self : file_descriptor_proto)
    (x : field_descriptor_proto list) : unit =
  self.extension <- x

let[@inline] file_descriptor_proto_set_options (self : file_descriptor_proto)
    (x : file_options) : unit =
  self.options <- Some x

let[@inline] file_descriptor_proto_set_source_code_info
    (self : file_descriptor_proto) (x : source_code_info) : unit =
  self.source_code_info <- Some x

let[@inline] file_descriptor_proto_set_syntax (self : file_descriptor_proto)
    (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.syntax <- x

let copy_file_descriptor_proto (self : file_descriptor_proto) :
    file_descriptor_proto =
  { self with name = self.name }

let make_file_descriptor_proto ?(name : string option)
    ?(package : string option) ?(dependency = []) ?(public_dependency = [])
    ?(weak_dependency = []) ?(message_type = []) ?(enum_type = [])
    ?(service = []) ?(extension = []) ?(options : file_options option)
    ?(source_code_info : source_code_info option) ?(syntax : string option) () :
    file_descriptor_proto =
...
let[@inline] file_descriptor_set_set_file (self : file_descriptor_set)
    (x : file_descriptor_proto list) : unit =
  self.file <- x
...
let make_file_descriptor_set ?(file = []) () : file_descriptor_set =
  let _res = default_file_descriptor_set () in
  file_descriptor_set_set_file _res file;
  _res

let[@inline] generated_code_info_annotation_has_source_file
    (self : generated_code_info_annotation) : bool =
  Pbrt.Bitfield.get self._presence 0

let[@inline] generated_code_info_annotation_has_begin_
    (self : generated_code_info_annotation) : bool =
  Pbrt.Bitfield.get self._presence 1

let[@inline] generated_code_info_annotation_has_end_
    (self : generated_code_info_annotation) : bool =
  Pbrt.Bitfield.get self._presence 2

let[@inline] generated_code_info_annotation_set_path
    (self : generated_code_info_annotation) (x : int32 list) : unit =
  self.path <- x

let[@inline] generated_code_info_annotation_set_source_file
    (self : generated_code_info_annotation) (x : string) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 0;
  self.source_file <- x

let[@inline] generated_code_info_annotation_set_begin_
    (self : generated_code_info_annotation) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 1;
  self.begin_ <- x

let[@inline] generated_code_info_annotation_set_end_
    (self : generated_code_info_annotation) (x : int32) : unit =
  self._presence <- Pbrt.Bitfield.set self._presence 2;
  self.end_ <- x

let copy_generated_code_info_annotation (self : generated_code_info_annotation)
    : generated_code_info_annotation =
  { self with path = self.path }

let make_generated_code_info_annotation ?(path = [])
    ?(source_file : string option) ?(begin_ : int32 option)
    ?(end_ : int32 option) () : generated_code_info_annotation =
...
let[@inline] generated_code_info_set_annotation (self : generated_code_info)
    (x : generated_code_info_annotation list) : unit =
  self.annotation <- x
...
let make_generated_code_info ?(annotation = []) () : generated_code_info =
...
let rec encode_pb_field_descriptor_proto_label
    (v : field_descriptor_proto_label) encoder =
  match v with
...
let rec encode_pb_field_descriptor_proto_type (v : field_descriptor_proto_type)
    encoder =
  match v with
...
let rec encode_pb_uninterpreted_option_name_part
    (v : uninterpreted_option_name_part) encoder =
...
let rec encode_pb_enum_value_descriptor_proto (v : enum_value_descriptor_proto)
    encoder =
...
let rec encode_pb_enum_descriptor_proto_enum_reserved_range
    (v : enum_descriptor_proto_enum_reserved_range) encoder =
...
let rec encode_pb_enum_descriptor_proto (v : enum_descriptor_proto) encoder =
  ...
  Pbrt.List_util.rev_iter_with
    (fun x encoder ->
      Pbrt.Encoder.nested encode_pb_enum_descriptor_proto_enum_reserved_range x
        encoder;
...
let rec encode_pb_descriptor_proto_extension_range
    (v : descriptor_proto_extension_range) encoder =
...
let rec encode_pb_descriptor_proto_reserved_range
    (v : descriptor_proto_reserved_range) encoder =
...
let rec encode_pb_method_options_idempotency_level
    (v : method_options_idempotency_level) encoder =
  match v with
...
let rec encode_pb_service_descriptor_proto (v : service_descriptor_proto)
    encoder =
...
let rec encode_pb_file_options_optimize_mode (v : file_options_optimize_mode)
    encoder =
  match v with
...
let rec encode_pb_source_code_info_location (v : source_code_info_location)
    encoder =
  Pbrt.Encoder.nested
    (fun lst encoder ->
      Pbrt.List_util.rev_iter_with
        (fun x encoder -> Pbrt.Encoder.int32_as_varint x encoder)
        lst encoder)
    v.path encoder;
  Pbrt.Encoder.key 1 Pbrt.Bytes encoder;
  Pbrt.Encoder.nested
...
let rec encode_pb_generated_code_info_annotation
    (v : generated_code_info_annotation) encoder =
  Pbrt.Encoder.nested
    (fun lst encoder ->
      Pbrt.List_util.rev_iter_with
        (fun x encoder -> Pbrt.Encoder.int32_as_varint x encoder)
...
let rec decode_pb_uninterpreted_option_name_part d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Bytes) ->
      uninterpreted_option_name_part_set_name_part v (Pbrt.Decoder.string d);
      name_part_is_set := true
    | Some (1, pk) ->
      Pbrt.Decoder.unexpected_payload_message "uninterpreted_option_name_part" 1
        pk
    | Some (2, Pbrt.Varint) ->
      uninterpreted_option_name_part_set_is_extension v (Pbrt.Decoder.bool d);
      is_extension_is_set := true
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message "uninterpreted_option_name_part" 2
        pk
...
let rec decode_pb_uninterpreted_option d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (2, Pbrt.Bytes) ->
      uninterpreted_option_set_name v
        (decode_pb_uninterpreted_option_name_part (Pbrt.Decoder.nested d)
        :: v.name)
    | Some (2, pk) ->
    ...
    | Some (4, Pbrt.Varint) ->
      uninterpreted_option_set_positive_int_value v
        (Pbrt.Decoder.int64_as_varint d)
    | Some (4, pk) ->
      Pbrt.Decoder.unexpected_payload_message "uninterpreted_option" 4 pk
    | Some (5, Pbrt.Varint) ->
      uninterpreted_option_set_negative_int_value v
        (Pbrt.Decoder.int64_as_varint d)
    | Some (5, pk) ->
...
let rec decode_pb_field_options d =
  ...
  while !continue__ do
    ...
    | Some (2, Pbrt.Varint) -> field_options_set_packed v (Pbrt.Decoder.bool d)
    | Some (2, pk) ->
    ...
    | Some (5, Pbrt.Varint) -> field_options_set_lazy_ v (Pbrt.Decoder.bool d)
    | Some (5, pk) ->
    ...
    | Some (10, Pbrt.Varint) -> field_options_set_weak v (Pbrt.Decoder.bool d)
    | Some (10, pk) ->
      Pbrt.Decoder.unexpected_payload_message "field_options" 10 pk
    | Some (999, Pbrt.Bytes) ->
      field_options_set_uninterpreted_option v
        (decode_pb_uninterpreted_option (Pbrt.Decoder.nested d)
        :: v.uninterpreted_option)
    | Some (999, pk) ->
...
let rec decode_pb_field_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | Some (4, Pbrt.Varint) ->
      field_descriptor_proto_set_label v
        (decode_pb_field_descriptor_proto_label d)
    | Some (4, pk) ->
      Pbrt.Decoder.unexpected_payload_message "field_descriptor_proto" 4 pk
    | Some (5, Pbrt.Varint) ->
      field_descriptor_proto_set_type_ v
        (decode_pb_field_descriptor_proto_type d)
    | Some (5, pk) ->
    ...
    | Some (8, Pbrt.Bytes) ->
      field_descriptor_proto_set_options v
        (decode_pb_field_options (Pbrt.Decoder.nested d))
    | Some (8, pk) ->
...
let rec decode_pb_enum_value_options d =
  ...
  while !continue__ do
    ...
    | None ->
      (* put lists in the correct order *)
      enum_value_options_set_uninterpreted_option v
        (List.rev v.uninterpreted_option);
      continue__ := false
    | Some (1, Pbrt.Varint) ->
...
let rec decode_pb_enum_value_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | Some (3, Pbrt.Bytes) ->
      enum_value_descriptor_proto_set_options v
        (decode_pb_enum_value_options (Pbrt.Decoder.nested d))
    | Some (3, pk) ->
...
let rec decode_pb_enum_options d =
  ...
  while !continue__ do
    ...
    | Some (999, Pbrt.Bytes) ->
      enum_options_set_uninterpreted_option v
        (decode_pb_uninterpreted_option (Pbrt.Decoder.nested d)
        :: v.uninterpreted_option)
    | Some (999, pk) ->
...
let rec decode_pb_enum_descriptor_proto_enum_reserved_range d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Varint) ->
      enum_descriptor_proto_enum_reserved_range_set_start v
        (Pbrt.Decoder.int32_as_varint d)
    | Some (1, pk) ->
      Pbrt.Decoder.unexpected_payload_message
        "enum_descriptor_proto_enum_reserved_range" 1 pk
    | Some (2, Pbrt.Varint) ->
      enum_descriptor_proto_enum_reserved_range_set_end_ v
        (Pbrt.Decoder.int32_as_varint d)
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message
        "enum_descriptor_proto_enum_reserved_range" 2 pk
    | Some (_, payload_kind) -> Pbrt.Decoder.skip d payload_kind
  done;
...
let rec decode_pb_enum_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | Some (2, Pbrt.Bytes) ->
      enum_descriptor_proto_set_value v
        (decode_pb_enum_value_descriptor_proto (Pbrt.Decoder.nested d)
        :: v.value)
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message "enum_descriptor_proto" 2 pk
    | Some (3, Pbrt.Bytes) ->
      enum_descriptor_proto_set_options v
        (decode_pb_enum_options (Pbrt.Decoder.nested d))
    | Some (3, pk) ->
      Pbrt.Decoder.unexpected_payload_message "enum_descriptor_proto" 3 pk
    | Some (4, Pbrt.Bytes) ->
      enum_descriptor_proto_set_reserved_range v
        (decode_pb_enum_descriptor_proto_enum_reserved_range
           (Pbrt.Decoder.nested d)
        :: v.reserved_range)
    | Some (4, pk) ->
      Pbrt.Decoder.unexpected_payload_message "enum_descriptor_proto" 4 pk
    | Some (5, Pbrt.Bytes) ->
      enum_descriptor_proto_set_reserved_name v
        (Pbrt.Decoder.string d :: v.reserved_name)
    | Some (5, pk) ->
...
let rec decode_pb_extension_range_options d =
  ...
  while !continue__ do
    ...
    | None ->
      (* put lists in the correct order *)
      extension_range_options_set_uninterpreted_option v
        (List.rev v.uninterpreted_option);
      continue__ := false
    | Some (999, Pbrt.Bytes) ->
      extension_range_options_set_uninterpreted_option v
...
let rec decode_pb_descriptor_proto_extension_range d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Varint) ->
      descriptor_proto_extension_range_set_start v
        (Pbrt.Decoder.int32_as_varint d)
    | Some (1, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto_extension_range"
        1 pk
    | Some (2, Pbrt.Varint) ->
      descriptor_proto_extension_range_set_end_ v
        (Pbrt.Decoder.int32_as_varint d)
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto_extension_range"
        2 pk
    | Some (3, Pbrt.Bytes) ->
      descriptor_proto_extension_range_set_options v
        (decode_pb_extension_range_options (Pbrt.Decoder.nested d))
    | Some (3, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto_extension_range"
        3 pk
    | Some (_, payload_kind) -> Pbrt.Decoder.skip d payload_kind
...
let rec decode_pb_oneof_options d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (999, Pbrt.Bytes) ->
      oneof_options_set_uninterpreted_option v
        (decode_pb_uninterpreted_option (Pbrt.Decoder.nested d)
        :: v.uninterpreted_option)
    | Some (999, pk) ->
...
let rec decode_pb_oneof_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | Some (2, Pbrt.Bytes) ->
      oneof_descriptor_proto_set_options v
        (decode_pb_oneof_options (Pbrt.Decoder.nested d))
    | Some (2, pk) ->
...
let rec decode_pb_message_options d =
  ...
  while !continue__ do
    ...
    | None ->
      (* put lists in the correct order *)
      message_options_set_uninterpreted_option v
        (List.rev v.uninterpreted_option);
      continue__ := false
    | Some (1, Pbrt.Varint) ->
    ...
    | Some (2, Pbrt.Varint) ->
      message_options_set_no_standard_descriptor_accessor v
        (Pbrt.Decoder.bool d)
    | Some (2, pk) ->
...
let rec decode_pb_descriptor_proto_reserved_range d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Varint) ->
      descriptor_proto_reserved_range_set_start v
        (Pbrt.Decoder.int32_as_varint d)
    | Some (1, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto_reserved_range"
        1 pk
    | Some (2, Pbrt.Varint) ->
      descriptor_proto_reserved_range_set_end_ v
        (Pbrt.Decoder.int32_as_varint d)
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto_reserved_range"
        2 pk
...
let rec decode_pb_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | Some (2, Pbrt.Bytes) ->
      descriptor_proto_set_field v
        (decode_pb_field_descriptor_proto (Pbrt.Decoder.nested d) :: v.field)
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 2 pk
    | Some (6, Pbrt.Bytes) ->
      descriptor_proto_set_extension v
        (decode_pb_field_descriptor_proto (Pbrt.Decoder.nested d) :: v.extension)
    | Some (6, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 6 pk
    | Some (3, Pbrt.Bytes) ->
      descriptor_proto_set_nested_type v
        (decode_pb_descriptor_proto (Pbrt.Decoder.nested d) :: v.nested_type)
    | Some (3, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 3 pk
    | Some (4, Pbrt.Bytes) ->
      descriptor_proto_set_enum_type v
        (decode_pb_enum_descriptor_proto (Pbrt.Decoder.nested d) :: v.enum_type)
    | Some (4, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 4 pk
    | Some (5, Pbrt.Bytes) ->
      descriptor_proto_set_extension_range v
        (decode_pb_descriptor_proto_extension_range (Pbrt.Decoder.nested d)
        :: v.extension_range)
    | Some (5, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 5 pk
    | Some (8, Pbrt.Bytes) ->
      descriptor_proto_set_oneof_decl v
        (decode_pb_oneof_descriptor_proto (Pbrt.Decoder.nested d)
        :: v.oneof_decl)
    | Some (8, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 8 pk
    | Some (7, Pbrt.Bytes) ->
      descriptor_proto_set_options v
        (decode_pb_message_options (Pbrt.Decoder.nested d))
    | Some (7, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 7 pk
    | Some (9, Pbrt.Bytes) ->
      descriptor_proto_set_reserved_range v
        (decode_pb_descriptor_proto_reserved_range (Pbrt.Decoder.nested d)
        :: v.reserved_range)
    | Some (9, pk) ->
      Pbrt.Decoder.unexpected_payload_message "descriptor_proto" 9 pk
    | Some (10, Pbrt.Bytes) ->
      descriptor_proto_set_reserved_name v
        (Pbrt.Decoder.string d :: v.reserved_name)
    | Some (10, pk) ->
...
let rec decode_pb_method_options_idempotency_level d :
    method_options_idempotency_level =
  match Pbrt.Decoder.int_as_varint d with
...
let rec decode_pb_method_options d =
  ...
  while !continue__ do
    ...
    | None ->
      (* put lists in the correct order *)
      method_options_set_uninterpreted_option v
        (List.rev v.uninterpreted_option);
      continue__ := false
    | Some (33, Pbrt.Varint) ->
    ...
    | Some (34, Pbrt.Varint) ->
      method_options_set_idempotency_level v
        (decode_pb_method_options_idempotency_level d)
    | Some (34, pk) ->
...
let rec decode_pb_method_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | Some (4, Pbrt.Bytes) ->
      method_descriptor_proto_set_options v
        (decode_pb_method_options (Pbrt.Decoder.nested d))
    | Some (4, pk) ->
...
let rec decode_pb_service_options d =
  ...
  while !continue__ do
    ...
    | None ->
      (* put lists in the correct order *)
      service_options_set_uninterpreted_option v
        (List.rev v.uninterpreted_option);
      continue__ := false
    | Some (33, Pbrt.Varint) ->
...
let rec decode_pb_service_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | Some (2, Pbrt.Bytes) ->
      service_descriptor_proto_set_method_ v
        (decode_pb_method_descriptor_proto (Pbrt.Decoder.nested d) :: v.method_)
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message "service_descriptor_proto" 2 pk
    | Some (3, Pbrt.Bytes) ->
      service_descriptor_proto_set_options v
        (decode_pb_service_options (Pbrt.Decoder.nested d))
    | Some (3, pk) ->
...
let rec decode_pb_file_options d =
  ...
  while !continue__ do
    ...
    | Some (999, Pbrt.Bytes) ->
      file_options_set_uninterpreted_option v
        (decode_pb_uninterpreted_option (Pbrt.Decoder.nested d)
        :: v.uninterpreted_option)
    | Some (999, pk) ->
...
let rec decode_pb_source_code_info_location d =
  ...
  while !continue__ do
    ...
    | None ->
      (* put lists in the correct order *)
      source_code_info_location_set_leading_detached_comments v
        (List.rev v.leading_detached_comments);
      source_code_info_location_set_span v (List.rev v.span);
      source_code_info_location_set_path v (List.rev v.path);
      continue__ := false
    | Some (1, Pbrt.Bytes) ->
      source_code_info_location_set_path v
    ...
    | Some (2, Pbrt.Bytes) ->
      source_code_info_location_set_span v
      @@ Pbrt.Decoder.packed_fold
           (fun l d -> Pbrt.Decoder.int32_as_varint d :: l)
           [] d
    | Some (2, pk) ->
...
let rec decode_pb_source_code_info d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Bytes) ->
      source_code_info_set_location v
        (decode_pb_source_code_info_location (Pbrt.Decoder.nested d)
        :: v.location)
    | Some (1, pk) ->
...
let rec decode_pb_file_descriptor_proto d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      file_descriptor_proto_set_public_dependency v
        (List.rev v.public_dependency);
    ...
    | Some (3, Pbrt.Bytes) ->
      file_descriptor_proto_set_dependency v
        (Pbrt.Decoder.string d :: v.dependency)
    | Some (3, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 3 pk
    | Some (10, Pbrt.Varint) ->
      file_descriptor_proto_set_public_dependency v
        (Pbrt.Decoder.int32_as_varint d :: v.public_dependency)
    | Some (10, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 10 pk
    | Some (11, Pbrt.Varint) ->
      file_descriptor_proto_set_weak_dependency v
        (Pbrt.Decoder.int32_as_varint d :: v.weak_dependency)
    | Some (11, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 11 pk
    | Some (4, Pbrt.Bytes) ->
      file_descriptor_proto_set_message_type v
        (decode_pb_descriptor_proto (Pbrt.Decoder.nested d) :: v.message_type)
    | Some (4, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 4 pk
    | Some (5, Pbrt.Bytes) ->
      file_descriptor_proto_set_enum_type v
        (decode_pb_enum_descriptor_proto (Pbrt.Decoder.nested d) :: v.enum_type)
    | Some (5, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 5 pk
    | Some (6, Pbrt.Bytes) ->
      file_descriptor_proto_set_service v
        (decode_pb_service_descriptor_proto (Pbrt.Decoder.nested d) :: v.service)
    | Some (6, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 6 pk
    | Some (7, Pbrt.Bytes) ->
      file_descriptor_proto_set_extension v
        (decode_pb_field_descriptor_proto (Pbrt.Decoder.nested d) :: v.extension)
    | Some (7, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 7 pk
    | Some (8, Pbrt.Bytes) ->
      file_descriptor_proto_set_options v
        (decode_pb_file_options (Pbrt.Decoder.nested d))
    | Some (8, pk) ->
      Pbrt.Decoder.unexpected_payload_message "file_descriptor_proto" 8 pk
    | Some (9, Pbrt.Bytes) ->
      file_descriptor_proto_set_source_code_info v
        (decode_pb_source_code_info (Pbrt.Decoder.nested d))
    | Some (9, pk) ->
...
let rec decode_pb_file_descriptor_set d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Bytes) ->
      file_descriptor_set_set_file v
        (decode_pb_file_descriptor_proto (Pbrt.Decoder.nested d) :: v.file)
    | Some (1, pk) ->
...
let rec decode_pb_generated_code_info_annotation d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Bytes) ->
      generated_code_info_annotation_set_path v
      @@ Pbrt.Decoder.packed_fold
           (fun l d -> Pbrt.Decoder.int32_as_varint d :: l)
           [] d
    | Some (1, pk) ->
      Pbrt.Decoder.unexpected_payload_message "generated_code_info_annotation" 1
        pk
    | Some (2, Pbrt.Bytes) ->
      generated_code_info_annotation_set_source_file v (Pbrt.Decoder.string d)
    | Some (2, pk) ->
      Pbrt.Decoder.unexpected_payload_message "generated_code_info_annotation" 2
        pk
    | Some (3, Pbrt.Varint) ->
      generated_code_info_annotation_set_begin_ v
        (Pbrt.Decoder.int32_as_varint d)
    | Some (3, pk) ->
      Pbrt.Decoder.unexpected_payload_message "generated_code_info_annotation" 3
        pk
    | Some (4, Pbrt.Varint) ->
      generated_code_info_annotation_set_end_ v (Pbrt.Decoder.int32_as_varint d)
    | Some (4, pk) ->
      Pbrt.Decoder.unexpected_payload_message "generated_code_info_annotation" 4
        pk
    | Some (_, payload_kind) -> Pbrt.Decoder.skip d payload_kind
  done;
...
let rec decode_pb_generated_code_info d =
  ...
  while !continue__ do
    ...
    | None ->
      ...
      continue__ := false
    | Some (1, Pbrt.Bytes) ->
      generated_code_info_set_annotation v
        (decode_pb_generated_code_info_annotation (Pbrt.Decoder.nested d)
        :: v.annotation)
    | Some (1, pk) ->
...
let rec encode_json_field_descriptor_proto_label
    (v : field_descriptor_proto_label) =
  match v with
  | Label_optional -> `String "LABEL_OPTIONAL"
  | Label_required -> `String "LABEL_REQUIRED"
  | Label_repeated -> `String "LABEL_REPEATED"

let rec encode_json_field_descriptor_proto_type
    (v : field_descriptor_proto_type) =
  match v with
...
let rec encode_json_uninterpreted_option_name_part
    (v : uninterpreted_option_name_part) =
  let assoc = ref [] in
...
let rec encode_json_uninterpreted_option (v : uninterpreted_option) =
  ...
  if uninterpreted_option_has_identifier_value v then
    assoc :=
      ("identifierValue", Pbrt_yojson.make_string v.identifier_value) :: !assoc;
  if uninterpreted_option_has_positive_int_value v then
    assoc :=
      ( "positiveIntValue",
        Pbrt_yojson.make_string (Int64.to_string v.positive_int_value) )
      :: !assoc;
  if uninterpreted_option_has_negative_int_value v then
    assoc :=
      ( "negativeIntValue",
        Pbrt_yojson.make_string (Int64.to_string v.negative_int_value) )
      :: !assoc;
  if uninterpreted_option_has_double_value v then
    assoc :=
      ("doubleValue", Pbrt_yojson.make_string (string_of_float v.double_value))
      :: !assoc;
  if uninterpreted_option_has_string_value v then
    assoc := ("stringValue", Pbrt_yojson.make_bytes v.string_value) :: !assoc;
  if uninterpreted_option_has_aggregate_value v then
    assoc :=
      ("aggregateValue", Pbrt_yojson.make_string v.aggregate_value) :: !assoc;
  `Assoc !assoc
...
let rec encode_json_field_options (v : field_options) =
  ...
  if field_options_has_unverified_lazy v then
    assoc :=
      ("unverifiedLazy", Pbrt_yojson.make_bool v.unverified_lazy) :: !assoc;
  if field_options_has_deprecated v then
  ...
  (assoc :=
     let l =
       v.uninterpreted_option |> List.map encode_json_uninterpreted_option
     in
...
let rec encode_json_field_descriptor_proto (v : field_descriptor_proto) =
  ...
  if field_descriptor_proto_has_label v then
    assoc :=
      ("label", encode_json_field_descriptor_proto_label v.label) :: !assoc;
  if field_descriptor_proto_has_type_ v then
  ...
  if field_descriptor_proto_has_oneof_index v then
    assoc :=
      ("oneofIndex", Pbrt_yojson.make_int (Int32.to_int v.oneof_index))
      :: !assoc;
  if field_descriptor_proto_has_json_name v then
  ...
  if field_descriptor_proto_has_proto3_optional v then
    assoc :=
      ("proto3Optional", Pbrt_yojson.make_bool v.proto3_optional) :: !assoc;
  `Assoc !assoc
...
let rec encode_json_enum_value_descriptor_proto
    (v : enum_value_descriptor_proto) =
  let assoc = ref [] in
  if enum_value_descriptor_proto_has_name v then
    assoc := ("name", Pbrt_yojson.make_string v.name) :: !assoc;
...
let rec encode_json_enum_descriptor_proto_enum_reserved_range
    (v : enum_descriptor_proto_enum_reserved_range) =
  let assoc = ref [] in
  if enum_descriptor_proto_enum_reserved_range_has_start v then
...
let rec encode_json_enum_descriptor_proto (v : enum_descriptor_proto) =
  ...
  (assoc :=
     let l =
       v.reserved_range
       |> List.map encode_json_enum_descriptor_proto_enum_reserved_range
     in
...
let rec encode_json_descriptor_proto_extension_range
    (v : descriptor_proto_extension_range) =
  let assoc = ref [] in
  if descriptor_proto_extension_range_has_start v then
    assoc := ("start", Pbrt_yojson.make_int (Int32.to_int v.start)) :: !assoc;
...
let rec encode_json_message_options (v : message_options) =
  ...
  if message_options_has_message_set_wire_format v then
    assoc :=
      ("messageSetWireFormat", Pbrt_yojson.make_bool v.message_set_wire_format)
      :: !assoc;
  if message_options_has_no_standard_descriptor_accessor v then
    assoc :=
      ( "noStandardDescriptorAccessor",
        Pbrt_yojson.make_bool v.no_standard_descriptor_accessor )
      :: !assoc;
  if message_options_has_deprecated v then
    assoc := ("deprecated", Pbrt_yojson.make_bool v.deprecated) :: !assoc;
  if message_options_has_map_entry v then
...
let rec encode_json_descriptor_proto_reserved_range
    (v : descriptor_proto_reserved_range) =
  let assoc = ref [] in
  if descriptor_proto_reserved_range_has_start v then
    assoc := ("start", Pbrt_yojson.make_int (Int32.to_int v.start)) :: !assoc;
...
let rec encode_json_descriptor_proto (v : descriptor_proto) =
  ...
  (assoc :=
     let l =
       v.extension_range
       |> List.map encode_json_descriptor_proto_extension_range
     in
  ...
  (assoc :=
     let l =
       v.reserved_range |> List.map encode_json_descriptor_proto_reserved_range
     in
     ("reservedRange", `List l) :: !assoc);
  (assoc :=
     let l = v.reserved_name |> List.map Pbrt_yojson.make_string in
...
let rec encode_json_method_options_idempotency_level
    (v : method_options_idempotency_level) =
  match v with
...
let rec encode_json_method_options (v : method_options) =
  ...
  if method_options_has_idempotency_level v then
    assoc :=
      ( "idempotencyLevel",
        encode_json_method_options_idempotency_level v.idempotency_level )
      :: !assoc;
  (assoc :=
     let l =
       v.uninterpreted_option |> List.map encode_json_uninterpreted_option
...
let rec encode_json_method_descriptor_proto (v : method_descriptor_proto) =
  ...
  if method_descriptor_proto_has_client_streaming v then
    assoc :=
      ("clientStreaming", Pbrt_yojson.make_bool v.client_streaming) :: !assoc;
  if method_descriptor_proto_has_server_streaming v then
    assoc :=
      ("serverStreaming", Pbrt_yojson.make_bool v.server_streaming) :: !assoc;
  `Assoc !assoc
...
let rec encode_json_file_options (v : file_options) =
  ...
  if file_options_has_java_outer_classname v then
    assoc :=
      ("javaOuterClassname", Pbrt_yojson.make_string v.java_outer_classname)
      :: !assoc;
  if file_options_has_java_multiple_files v then
    assoc :=
      ("javaMultipleFiles", Pbrt_yojson.make_bool v.java_multiple_files)
      :: !assoc;
  if file_options_has_java_generate_equals_and_hash v then
    assoc :=
      ( "javaGenerateEqualsAndHash",
        Pbrt_yojson.make_bool v.java_generate_equals_and_hash )
      :: !assoc;
  if file_options_has_java_string_check_utf8 v then
    assoc :=
      ("javaStringCheckUtf8", Pbrt_yojson.make_bool v.java_string_check_utf8)
      :: !assoc;
  if file_options_has_optimize_for v then
    assoc :=
      ("optimizeFor", encode_json_file_options_optimize_mode v.optimize_for)
      :: !assoc;
  if file_options_has_go_package v then
    assoc := ("goPackage", Pbrt_yojson.make_string v.go_package) :: !assoc;
  if file_options_has_cc_generic_services v then
    assoc :=
      ("ccGenericServices", Pbrt_yojson.make_bool v.cc_generic_services)
      :: !assoc;
  if file_options_has_java_generic_services v then
    assoc :=
      ("javaGenericServices", Pbrt_yojson.make_bool v.java_generic_services)
      :: !assoc;
  if file_options_has_py_generic_services v then
    assoc :=
      ("pyGenericServices", Pbrt_yojson.make_bool v.py_generic_services)
      :: !assoc;
  if file_options_has_php_generic_services v then
    assoc :=
      ("phpGenericServices", Pbrt_yojson.make_bool v.php_generic_services)
      :: !assoc;
  if file_options_has_deprecated v then
    assoc := ("deprecated", Pbrt_yojson.make_bool v.deprecated) :: !assoc;
  if file_options_has_cc_enable_arenas v then
    assoc :=
      ("ccEnableArenas", Pbrt_yojson.make_bool v.cc_enable_arenas) :: !assoc;
  if file_options_has_objc_class_prefix v then
    assoc :=
      ("objcClassPrefix", Pbrt_yojson.make_string v.objc_class_prefix) :: !assoc;
  if file_options_has_csharp_namespace v then
    assoc :=
      ("csharpNamespace", Pbrt_yojson.make_string v.csharp_namespace) :: !assoc;
  if file_options_has_swift_prefix v then
    assoc := ("swiftPrefix", Pbrt_yojson.make_string v.swift_prefix) :: !assoc;
  if file_options_has_php_class_prefix v then
    assoc :=
      ("phpClassPrefix", Pbrt_yojson.make_string v.php_class_prefix) :: !assoc;
  if file_options_has_php_namespace v then
    assoc := ("phpNamespace", Pbrt_yojson.make_string v.php_namespace) :: !assoc;
  if file_options_has_php_metadata_namespace v then
    assoc :=
      ("phpMetadataNamespace", Pbrt_yojson.make_string v.php_metadata_namespace)
      :: !assoc;
  if file_options_has_ruby_package v then
...
let rec encode_json_source_code_info_location (v : source_code_info_location) =
  ...
  if source_code_info_location_has_leading_comments v then
    assoc :=
      ("leadingComments", Pbrt_yojson.make_string v.leading_comments) :: !assoc;
  if source_code_info_location_has_trailing_comments v then
    assoc :=
      ("trailingComments", Pbrt_yojson.make_string v.trailing_comments)
      :: !assoc;
  (assoc :=
...
let rec encode_json_file_descriptor_proto (v : file_descriptor_proto) =
  ...
  (assoc :=
     let l =
       v.public_dependency |> List.map Int32.to_int
       |> List.map Pbrt_yojson.make_int
     in
     ("publicDependency", `List l) :: !assoc);
  (assoc :=
     let l =
       v.weak_dependency |> List.map Int32.to_int
       |> List.map Pbrt_yojson.make_int
     in
...
let rec encode_json_generated_code_info_annotation
    (v : generated_code_info_annotation) =
  let assoc = ref [] in
  (assoc :=
     let l = v.path |> List.map Int32.to_int |> List.map Pbrt_yojson.make_int in
...
let rec encode_json_generated_code_info (v : generated_code_info) =
  ...
  (assoc :=
     let l =
       v.annotation |> List.map encode_json_generated_code_info_annotation
     in
...
let rec decode_json_uninterpreted_option_name_part d =
  ...
  List.iter
    (function
      | "namePart", json_value ->
        uninterpreted_option_name_part_set_name_part v
          (Pbrt_yojson.string json_value "uninterpreted_option_name_part"
             "name_part")
      | "isExtension", json_value ->
        uninterpreted_option_name_part_set_is_extension v
          (Pbrt_yojson.bool json_value "uninterpreted_option_name_part"
             "is_extension")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ name_part = v.name_part; is_extension = v.is_extension }
    : uninterpreted_option_name_part)
    ...
    (function
      | "name", `List l ->
        ...
        @@ List.map
             (function
               | json_value ->
                 decode_json_uninterpreted_option_name_part json_value)
             l
      | "identifierValue", json_value ->
        uninterpreted_option_set_identifier_value v
          (Pbrt_yojson.string json_value "uninterpreted_option"
             "identifier_value")
      | "positiveIntValue", json_value ->
        uninterpreted_option_set_positive_int_value v
          (Pbrt_yojson.int64 json_value "uninterpreted_option"
             "positive_int_value")
      ...
      | "doubleValue", json_value ->
        uninterpreted_option_set_double_value v
          (Pbrt_yojson.float json_value "uninterpreted_option" "double_value")
      | "stringValue", json_value ->
        uninterpreted_option_set_string_value v
          (Pbrt_yojson.bytes json_value "uninterpreted_option" "string_value")
      | "aggregateValue", json_value ->
        uninterpreted_option_set_aggregate_value v
          (Pbrt_yojson.string json_value "uninterpreted_option"
             "aggregate_value")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
...
let rec decode_json_field_options d =
  ...
  List.iter
    (function
      ...
      | "packed", json_value ->
        field_options_set_packed v
          (Pbrt_yojson.bool json_value "field_options" "packed")
      | "jstype", json_value ->
        field_options_set_jstype v (decode_json_field_options_jstype json_value)
      | "lazy", json_value ->
        field_options_set_lazy_ v
          (Pbrt_yojson.bool json_value "field_options" "lazy_")
      | "unverifiedLazy", json_value ->
        field_options_set_unverified_lazy v
          (Pbrt_yojson.bool json_value "field_options" "unverified_lazy")
      | "deprecated", json_value ->
        field_options_set_deprecated v
          (Pbrt_yojson.bool json_value "field_options" "deprecated")
      | "weak", json_value ->
        field_options_set_weak v
          (Pbrt_yojson.bool json_value "field_options" "weak")
      | "uninterpretedOption", `List l ->
        field_options_set_uninterpreted_option v
        @@ List.map
             (function
...
let rec decode_json_field_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        field_descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "field_descriptor_proto" "name")
      | "number", json_value ->
        field_descriptor_proto_set_number v
          (Pbrt_yojson.int32 json_value "field_descriptor_proto" "number")
      | "label", json_value ->
        field_descriptor_proto_set_label v
          (decode_json_field_descriptor_proto_label json_value)
      | "type", json_value ->
        field_descriptor_proto_set_type_ v
          (decode_json_field_descriptor_proto_type json_value)
      | "typeName", json_value ->
        field_descriptor_proto_set_type_name v
          (Pbrt_yojson.string json_value "field_descriptor_proto" "type_name")
      | "extendee", json_value ->
        field_descriptor_proto_set_extendee v
          (Pbrt_yojson.string json_value "field_descriptor_proto" "extendee")
      | "defaultValue", json_value ->
        field_descriptor_proto_set_default_value v
          (Pbrt_yojson.string json_value "field_descriptor_proto"
             "default_value")
      | "oneofIndex", json_value ->
        field_descriptor_proto_set_oneof_index v
          (Pbrt_yojson.int32 json_value "field_descriptor_proto" "oneof_index")
      | "jsonName", json_value ->
        field_descriptor_proto_set_json_name v
          (Pbrt_yojson.string json_value "field_descriptor_proto" "json_name")
      | "options", json_value ->
        field_descriptor_proto_set_options v
          (decode_json_field_options json_value)
      | "proto3Optional", json_value ->
        field_descriptor_proto_set_proto3_optional v
          (Pbrt_yojson.bool json_value "field_descriptor_proto"
             "proto3_optional")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({
...
let rec decode_json_enum_value_options d =
  ...
  List.iter
    (function
      | "deprecated", json_value ->
        enum_value_options_set_deprecated v
          (Pbrt_yojson.bool json_value "enum_value_options" "deprecated")
      | "uninterpretedOption", `List l ->
        enum_value_options_set_uninterpreted_option v
        @@ List.map
             (function
...
let rec decode_json_enum_value_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        enum_value_descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "enum_value_descriptor_proto" "name")
      | "number", json_value ->
        enum_value_descriptor_proto_set_number v
          (Pbrt_yojson.int32 json_value "enum_value_descriptor_proto" "number")
      | "options", json_value ->
        enum_value_descriptor_proto_set_options v
          (decode_json_enum_value_options json_value)
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({
     _presence = v._presence;
  ...
  List.iter
    (function
      | "allowAlias", json_value ->
        enum_options_set_allow_alias v
          (Pbrt_yojson.bool json_value "enum_options" "allow_alias")
      | "deprecated", json_value ->
        enum_options_set_deprecated v
          (Pbrt_yojson.bool json_value "enum_options" "deprecated")
      | "uninterpretedOption", `List l ->
        enum_options_set_uninterpreted_option v
        @@ List.map
             (function
...
let rec decode_json_enum_descriptor_proto_enum_reserved_range d =
  ...
  List.iter
    (function
      | "start", json_value ->
        enum_descriptor_proto_enum_reserved_range_set_start v
          (Pbrt_yojson.int32 json_value
             "enum_descriptor_proto_enum_reserved_range" "start")
      | "end", json_value ->
        enum_descriptor_proto_enum_reserved_range_set_end_ v
          (Pbrt_yojson.int32 json_value
             "enum_descriptor_proto_enum_reserved_range" "end_")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ _presence = v._presence; start = v.start; end_ = v.end_ }
    : enum_descriptor_proto_enum_reserved_range)
...
let rec decode_json_enum_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        enum_descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "enum_descriptor_proto" "name")
      | "value", `List l ->
        enum_descriptor_proto_set_value v
        @@ List.map
             (function
               | json_value ->
                 decode_json_enum_value_descriptor_proto json_value)
             l
      | "options", json_value ->
        enum_descriptor_proto_set_options v
          (decode_json_enum_options json_value)
      | "reservedRange", `List l ->
        enum_descriptor_proto_set_reserved_range v
        @@ List.map
             (function
               | json_value ->
                 decode_json_enum_descriptor_proto_enum_reserved_range
                   json_value)
             l
      | "reservedName", `List l ->
        enum_descriptor_proto_set_reserved_name v
        @@ List.map
             (function
               | json_value ->
                 Pbrt_yojson.string json_value "enum_descriptor_proto"
                   "reserved_name")
             l
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
...
let rec decode_json_extension_range_options d =
  ...
  List.iter
    (function
      ...
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ uninterpreted_option = v.uninterpreted_option } : extension_range_options)
...
let rec decode_json_descriptor_proto_extension_range d =
  ...
  List.iter
    (function
      | "start", json_value ->
        descriptor_proto_extension_range_set_start v
          (Pbrt_yojson.int32 json_value "descriptor_proto_extension_range"
             "start")
      | "end", json_value ->
        descriptor_proto_extension_range_set_end_ v
          (Pbrt_yojson.int32 json_value "descriptor_proto_extension_range"
      ...
      | "options", json_value ->
        descriptor_proto_extension_range_set_options v
          (decode_json_extension_range_options json_value)
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({
     _presence = v._presence;
...
let rec decode_json_oneof_options d =
  ...
  List.iter
    (function
      ...
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ uninterpreted_option = v.uninterpreted_option } : oneof_options)
...
let rec decode_json_oneof_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        oneof_descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "oneof_descriptor_proto" "name")
      | "options", json_value ->
        oneof_descriptor_proto_set_options v
          (decode_json_oneof_options json_value)
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ _presence = v._presence; name = v.name; options = v.options }
    : oneof_descriptor_proto)
  ...
  List.iter
    (function
      | "messageSetWireFormat", json_value ->
        message_options_set_message_set_wire_format v
          (Pbrt_yojson.bool json_value "message_options"
      ...
      | "deprecated", json_value ->
        message_options_set_deprecated v
          (Pbrt_yojson.bool json_value "message_options" "deprecated")
      | "mapEntry", json_value ->
        message_options_set_map_entry v
          (Pbrt_yojson.bool json_value "message_options" "map_entry")
      | "uninterpretedOption", `List l ->
        message_options_set_uninterpreted_option v
        @@ List.map
             (function
...
let rec decode_json_descriptor_proto_reserved_range d =
  ...
  List.iter
    (function
      | "start", json_value ->
        descriptor_proto_reserved_range_set_start v
          (Pbrt_yojson.int32 json_value "descriptor_proto_reserved_range"
             "start")
      | "end", json_value ->
        descriptor_proto_reserved_range_set_end_ v
          (Pbrt_yojson.int32 json_value "descriptor_proto_reserved_range" "end_")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ _presence = v._presence; start = v.start; end_ = v.end_ }
...
let rec decode_json_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "descriptor_proto" "name")
      | "field", `List l ->
        descriptor_proto_set_field v
        @@ List.map
             (function
      ...
      | "enumType", `List l ->
        ...
        @@ List.map
             ...
             l
      | "extensionRange", `List l ->
        descriptor_proto_set_extension_range v
        @@ List.map
             (function
               | json_value ->
                 decode_json_descriptor_proto_extension_range json_value)
             l
      | "oneofDecl", `List l ->
        descriptor_proto_set_oneof_decl v
        @@ List.map
      ...
      | "reservedRange", `List l ->
        ...
        @@ List.map
             (function
               | json_value ->
                 decode_json_descriptor_proto_reserved_range json_value)
             l
      | "reservedName", `List l ->
        descriptor_proto_set_reserved_name v
        @@ List.map
             (function
               | json_value ->
                 Pbrt_yojson.string json_value "descriptor_proto"
                   "reserved_name")
             l
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
...
let rec decode_json_method_options_idempotency_level json =
  ...
  | `String "IDEMPOTENCY_UNKNOWN" ->
    (Idempotency_unknown : method_options_idempotency_level)
  | `String "NO_SIDE_EFFECTS" ->
    (No_side_effects : method_options_idempotency_level)
...
let rec decode_json_method_options d =
  ...
  List.iter
    (function
      | "deprecated", json_value ->
        method_options_set_deprecated v
          (Pbrt_yojson.bool json_value "method_options" "deprecated")
      | "idempotencyLevel", json_value ->
        method_options_set_idempotency_level v
          (decode_json_method_options_idempotency_level json_value)
      | "uninterpretedOption", `List l ->
        method_options_set_uninterpreted_option v
        @@ List.map
             (function
...
let rec decode_json_method_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        method_descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "method_descriptor_proto" "name")
      | "inputType", json_value ->
        method_descriptor_proto_set_input_type v
          (Pbrt_yojson.string json_value "method_descriptor_proto" "input_type")
      | "outputType", json_value ->
        method_descriptor_proto_set_output_type v
          (Pbrt_yojson.string json_value "method_descriptor_proto" "output_type")
      | "options", json_value ->
        method_descriptor_proto_set_options v
          (decode_json_method_options json_value)
      | "clientStreaming", json_value ->
        method_descriptor_proto_set_client_streaming v
          (Pbrt_yojson.bool json_value "method_descriptor_proto"
             "client_streaming")
      | "serverStreaming", json_value ->
        method_descriptor_proto_set_server_streaming v
          (Pbrt_yojson.bool json_value "method_descriptor_proto"
             "server_streaming")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
...
let rec decode_json_service_options d =
  ...
  List.iter
    (function
      | "deprecated", json_value ->
        service_options_set_deprecated v
          (Pbrt_yojson.bool json_value "service_options" "deprecated")
      | "uninterpretedOption", `List l ->
        service_options_set_uninterpreted_option v
        @@ List.map
             (function
...
let rec decode_json_service_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        service_descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "service_descriptor_proto" "name")
      | "method", `List l ->
        service_descriptor_proto_set_method_ v
        @@ List.map
             (function
      ...
      | "options", json_value ->
        service_descriptor_proto_set_options v
          (decode_json_service_options json_value)
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({
     _presence = v._presence;
  ...
  List.iter
    (function
      | "javaPackage", json_value ->
        file_options_set_java_package v
          (Pbrt_yojson.string json_value "file_options" "java_package")
      | "javaOuterClassname", json_value ->
        file_options_set_java_outer_classname v
          (Pbrt_yojson.string json_value "file_options" "java_outer_classname")
      | "javaMultipleFiles", json_value ->
        file_options_set_java_multiple_files v
          (Pbrt_yojson.bool json_value "file_options" "java_multiple_files")
      | "javaGenerateEqualsAndHash", json_value ->
        file_options_set_java_generate_equals_and_hash v
          (Pbrt_yojson.bool json_value "file_options"
             "java_generate_equals_and_hash")
      | "javaStringCheckUtf8", json_value ->
        file_options_set_java_string_check_utf8 v
          (Pbrt_yojson.bool json_value "file_options" "java_string_check_utf8")
      | "optimizeFor", json_value ->
        file_options_set_optimize_for v
          (decode_json_file_options_optimize_mode json_value)
      | "goPackage", json_value ->
        file_options_set_go_package v
          (Pbrt_yojson.string json_value "file_options" "go_package")
      | "ccGenericServices", json_value ->
        file_options_set_cc_generic_services v
          (Pbrt_yojson.bool json_value "file_options" "cc_generic_services")
      | "javaGenericServices", json_value ->
        file_options_set_java_generic_services v
          (Pbrt_yojson.bool json_value "file_options" "java_generic_services")
      | "pyGenericServices", json_value ->
        file_options_set_py_generic_services v
          (Pbrt_yojson.bool json_value "file_options" "py_generic_services")
      | "phpGenericServices", json_value ->
        file_options_set_php_generic_services v
          (Pbrt_yojson.bool json_value "file_options" "php_generic_services")
      | "deprecated", json_value ->
        file_options_set_deprecated v
          (Pbrt_yojson.bool json_value "file_options" "deprecated")
      | "ccEnableArenas", json_value ->
        file_options_set_cc_enable_arenas v
          (Pbrt_yojson.bool json_value "file_options" "cc_enable_arenas")
      | "objcClassPrefix", json_value ->
        file_options_set_objc_class_prefix v
          (Pbrt_yojson.string json_value "file_options" "objc_class_prefix")
      | "csharpNamespace", json_value ->
        file_options_set_csharp_namespace v
          (Pbrt_yojson.string json_value "file_options" "csharp_namespace")
      | "swiftPrefix", json_value ->
        file_options_set_swift_prefix v
          (Pbrt_yojson.string json_value "file_options" "swift_prefix")
      | "phpClassPrefix", json_value ->
        file_options_set_php_class_prefix v
          (Pbrt_yojson.string json_value "file_options" "php_class_prefix")
      | "phpNamespace", json_value ->
        file_options_set_php_namespace v
          (Pbrt_yojson.string json_value "file_options" "php_namespace")
      | "phpMetadataNamespace", json_value ->
        file_options_set_php_metadata_namespace v
          (Pbrt_yojson.string json_value "file_options" "php_metadata_namespace")
      | "rubyPackage", json_value ->
        file_options_set_ruby_package v
          (Pbrt_yojson.string json_value "file_options" "ruby_package")
      | "uninterpretedOption", `List l ->
        file_options_set_uninterpreted_option v
        @@ List.map
             (function
    ...
    (function
      | "path", `List l ->
        ...
        @@ List.map
             (function
               | json_value ->
                 Pbrt_yojson.int32 json_value "source_code_info_location" "path")
             l
      | "span", `List l ->
        source_code_info_location_set_span v
        @@ List.map
             (function
               | json_value ->
                 Pbrt_yojson.int32 json_value "source_code_info_location" "span")
             l
      | "leadingComments", json_value ->
        source_code_info_location_set_leading_comments v
          (Pbrt_yojson.string json_value "source_code_info_location"
             "leading_comments")
      | "trailingComments", json_value ->
        source_code_info_location_set_trailing_comments v
          (Pbrt_yojson.string json_value "source_code_info_location"
             "trailing_comments")
      | "leadingDetachedComments", `List l ->
        source_code_info_location_set_leading_detached_comments v
        @@ List.map
             (function
               | json_value ->
...
let rec decode_json_source_code_info d =
  ...
  List.iter
    (function
      ...
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ location = v.location } : source_code_info)
...
let rec decode_json_file_descriptor_proto d =
  ...
  List.iter
    (function
      | "name", json_value ->
        file_descriptor_proto_set_name v
          (Pbrt_yojson.string json_value "file_descriptor_proto" "name")
      | "package", json_value ->
        file_descriptor_proto_set_package v
          (Pbrt_yojson.string json_value "file_descriptor_proto" "package")
      | "dependency", `List l ->
        file_descriptor_proto_set_dependency v
        @@ List.map
             (function
               | json_value ->
                 Pbrt_yojson.string json_value "file_descriptor_proto"
                   "dependency")
             l
      | "publicDependency", `List l ->
        file_descriptor_proto_set_public_dependency v
        @@ List.map
             (function
               | json_value ->
                 Pbrt_yojson.int32 json_value "file_descriptor_proto"
                   "public_dependency")
             l
      | "weakDependency", `List l ->
        file_descriptor_proto_set_weak_dependency v
        @@ List.map
             (function
               | json_value ->
      ...
      | "options", json_value ->
        file_descriptor_proto_set_options v
          (decode_json_file_options json_value)
      | "sourceCodeInfo", json_value ->
        file_descriptor_proto_set_source_code_info v
          (decode_json_source_code_info json_value)
      | "syntax", json_value ->
        file_descriptor_proto_set_syntax v
          (Pbrt_yojson.string json_value "file_descriptor_proto" "syntax")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({
     _presence = v._presence;
...
let rec decode_json_file_descriptor_set d =
  ...
  List.iter
    (function
      ...
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ file = v.file } : file_descriptor_set)
    ...
    (function
      | "path", `List l ->
        ...
        @@ List.map
             (function
               | json_value ->
                 Pbrt_yojson.int32 json_value "generated_code_info_annotation"
                   "path")
             l
      | "sourceFile", json_value ->
        generated_code_info_annotation_set_source_file v
          (Pbrt_yojson.string json_value "generated_code_info_annotation"
             "source_file")
      | "begin", json_value ->
        generated_code_info_annotation_set_begin_ v
          (Pbrt_yojson.int32 json_value "generated_code_info_annotation"
             "begin_")
      | "end", json_value ->
        generated_code_info_annotation_set_end_ v
          (Pbrt_yojson.int32 json_value "generated_code_info_annotation" "end_")
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({
     _presence = v._presence;
    ...
    (function
      | "annotation", `List l ->
        ...
        @@ List.map
             (function
               | json_value ->
                 decode_json_generated_code_info_annotation json_value)
             l
      | _, _ -> () (*Unknown fields are ignored*))
    assoc;
  ({ annotation = v.annotation } : generated_code_info)
